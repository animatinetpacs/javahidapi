...
public class HIDDevice {
    ...
    /**
     * Destructor to destroy the <code>HIDDevice</code> object. Calls the close()
     * native method.
     * 
     * @throws Throwable
     */
     ...
     * @return <code>true</code> if the <code>HIDDevice</code> object represent the
    ...
    /**
     * Close open device. Multiple calls allowed - id device was already closed no
     ...
     * @return the number of bytes to read. For devices with multiple reports, make
     *         sure to read an extra byte for the report number.
     */
