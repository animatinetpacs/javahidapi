...
public class HIDManager {
     ...
     * <code>HIDManager</code> object is no longer needed. Failure to do so could
     * cause memory leaks or unterminated threads. It is safe to call this method
     * multiple times.
     *
     */
    ...
    /**
     * Constructor to create HID object manager. It must be invoked from subclass
    ...
    /**
     * Convenience method to open a HID device using a Vendor ID (VID), Product ID
