...
public class HIDDeviceInfo {
    ...
    /**
     * Get the device release number in binary-coded decimal, also known as device
     * version number.
     * 
     * @return the integer value
     */
    ...
    /**
     * Get the USB interface which this logical device represents. Valid on both
     * Linux implementations in all cases, and valid on the Windows implementation
