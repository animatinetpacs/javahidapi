            ...
            try {
                ...
                if (in != null) {
                    try {
                        ...
                        System.out.println(String.format("fileOut %s.", fileOut));
                        ...
                        isHIDLibLoaded = true;
                        System.out.println(String.format("Successfully loading library: %s", fileOut.toString()));
                    } finally {
                        in.close();
                    }
                }
            } catch (Exception e) {
                System.out.println(String.format("Error loading library: %s", path));
                e.printStackTrace();
